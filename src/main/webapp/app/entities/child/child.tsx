...
import { searchEntities, getEntities } from './child.reducer';
  ...
  return (
    <div>
      <h2 id="child-heading" data-cy="ChildHeading">
        <Translate contentKey="sysParentApp.child.home.title">Children</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="sysParentApp.child.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/child/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="sysParentApp.child.home.createLabel">Create new Child</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('sysParentApp.child.home.search')}
                />
        ...
        {childList && childList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="sysParentApp.child.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="sysParentApp.child.name">Name</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('name')} />
                </th>
                <th className="hand" onClick={sort('age')}>
                  <Translate contentKey="sysParentApp.child.age">Age</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('age')} />
                </th>
                ...
                <th>
                  <Translate contentKey="sysParentApp.child.parent">Parent</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="sysParentApp.child.home.notFound">No Children found</Translate>
            </div>
          )
        )}
      </div>
