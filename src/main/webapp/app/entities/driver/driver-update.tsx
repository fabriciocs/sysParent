  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sysParentApp.driver.home.createOrEditLabel" data-cy="DriverCreateUpdateHeading">
            <Translate contentKey="sysParentApp.driver.home.createOrEditLabel">Create or edit a Driver</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('sysParentApp.driver.name')}
                id="driver-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('sysParentApp.driver.phone')}
                id="driver-phone"
                name="phone"
                data-cy="phone"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('sysParentApp.driver.email')}
                id="driver-email"
                name="email"
                data-cy="email"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('sysParentApp.driver.licenseNumber')}
