...
import { searchEntities, getEntities } from './parent.reducer';
  ...
  return (
    <div>
      <h2 id="parent-heading" data-cy="ParentHeading">
        <Translate contentKey="sysParentApp.parent.home.title">Parents</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="sysParentApp.parent.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/parent/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="sysParentApp.parent.home.createLabel">Create new Parent</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('sysParentApp.parent.home.search')}
                />
        ...
        {parentList && parentList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="sysParentApp.parent.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="sysParentApp.parent.home.notFound">No Parents found</Translate>
            </div>
          )
        )}
      </div>
