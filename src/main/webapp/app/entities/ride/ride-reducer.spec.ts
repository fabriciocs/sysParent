...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RIDE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_RIDES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RIDE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RIDE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RIDE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RIDE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RIDE actions', async () => {
      const arg = 42666;
